...
// FMA.cs
//
// A class that implements intrinsic functions to provide access to Intel FMA instructions.
//
// =+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+
...
{
    /// <summary>
    /// Provides access to Intel FMA hardware instructions via intrinsics
    /// </summary>
    /// <para>
    /// FMA class provides access to FMA instructions
    /// </para>
